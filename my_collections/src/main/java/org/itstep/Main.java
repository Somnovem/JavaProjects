...
import org.itstep.busstop.BusStop;
...
public class Main {
    ...
    public static void main(String[] args) {
        Runnable app = new BusStop();
        app.run();
    }

    private static void queueAvatars() {
...
//        }
    ...
    private static void createCollections() {
        ...
        stringQueue.add("as add");
        stringQueue.push("as push");
        stringQueue.addFirst("as add first");
    }

    private static void createArrayListAsInterface() {
    ...
    private static void createCollectionAsInterface() {
